	...
	render() {
	    ...
	    const form = (
	    	<ValidatorForm ref="registerForm" onSubmit={this.onSubmit}>
				...
				<RadioButtonGroup onChange={e => this.changeValue(e, 'gender')} className="rg-gender" name="gender" defaultSelected="">
					<RadioButton
				        value="male"
				        label="Male"
	            ...
	            <TextValidator
                    ...
                    style={customContentStyle.input}
                    onChange={e => this.changeValue(e, 'repeatPassword')}
                />
